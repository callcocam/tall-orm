...
use Tall\Orm\Core\Generators\Way\Generators\Commands\GeneratorCommand;
...
use Tall\Orm\Core\Generators\Syntax\AddToTable;
use Tall\Orm\Core\Generators\Syntax\DroppedTable;
use Tall\Orm\Core\Generators\Syntax\AddForeignKeysToTable;
use Tall\Orm\Core\Generators\Syntax\RemoveForeignKeysFromTable;
...
class MigrateGenerateCommand extends GeneratorCommand {
	...
	/**
	 * @var \Tall\Orm\Core\Generators\SchemaGenerator
	 */
    ...
    /**
	 * @param \Tall\Orm\Core\Generators\Way\Generators\Generator  $generator
	 * @param \Tall\Orm\Core\Generators\Way\Generators\Filesystem\Filesystem  $file
	 * @param \Tall\Orm\Core\Generators\Way\Generators\Compilers\TemplateCompiler  $compiler
